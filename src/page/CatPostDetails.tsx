...
const CatPostDetails = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <img className="w-full h-96 object-cover" src="img/1.jpg" alt="Imagen del michi"/>
        <div className="p-8">
            <div className="flex justify-between items-center mb-4">
                <span className="inline-block px-3 py-1 text-sm font-semibold rounded-full bg-emerald-400 text-white">
                    En Adopción
                </span>
                <span className="text-gray-600 text-sm">Publicado: 17/07/2025</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4 text-sm text-gray-700">
                ...
                <div><strong className="font-semibold">Edad:</strong> 2 años</div>
                <div><strong className="font-semibold">Raza:</strong> Siamés</div>
                <div><strong className="font-semibold">Ubicación:</strong> Barrio Las Rosas, San Nicolás</div>
            </div>
